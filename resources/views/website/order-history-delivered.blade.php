                ...
                <div class="col-lg-8 left-order-details">
                    <div class="order-dtls-in">
                        ...
                        <div class="order-activity">
                            ...
                            <div class="activity-item-dtls1">Your item has been picked up by delivery partner. </div>
                            <div class="activity-item-dtls2">Sat, 29th Mar '25 - 6:57am </div>
                          </div> -->
                            </div>
                            <div class="activity-item green">
                                <h6>Shipped <span> Sat, 29th Mar '25</span></h6>
                                <p>Saturday</p>
                            </div>
                            <div class="activity-item green">
                                <h6>Delivered <span> 2nd Apr '25</span></h6>
                                <p>Monday</p>
                            </div>
                        </div>
